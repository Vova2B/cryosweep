...
- **Recognized-but-deferred** (reported in `capabilities[]`, not yet fitted): activated transport (Arrhenius ρ=ρ₀·exp(Eₐ/k_BT); Mott VRH ρ∝exp[(T₀/T)^(1/4)]), Kondo ρ=ρ₀−c·ln T, full Bloch-Grüneisen, Kohler's rule.
